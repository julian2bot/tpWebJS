        ...
        for (let character of characters) {
            ...
            <div class="image">
                <div class="persoPreview">
                    ...
                    <img class="imgPersoCasque" src="${ENDPOINT + Favoris.equipement.heads.img}">
                    <img class="imgPersoHaut" src="${ENDPOINT + Favoris.equipement.torso.img}">
                    <img class="imgPersoBas" src="${ENDPOINT + Favoris.equipement.pants.img}">
                    <img class="imgPersoBasBas" src="${ENDPOINT + Favoris.equipement.shoes.img}">
                </div>
            </div>
            <div class="stats">
                <div class="stat">
